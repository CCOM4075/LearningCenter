                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input class="form-control" type="number" id="edificio"  name="edificio" min="101" max="111">
                                                    <small class="form-text text-muted"></small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input class="form-control" type="number" id="unidad" name="unidad" min="1" max="100">
                                                    <small class="form-text text-muted"></small>
                                                </div>
                                            </div>
